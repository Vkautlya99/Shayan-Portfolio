...
const WorkAndAchievements = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Work & Achievements - Shayan Krishna | Actor, Model & Influencer
        </title>
        <meta
          name="description"
      ...
      <div>
        <div data-aos="fade-left" data-aos-mirror="true" className="">
          <h1 className="text-4xl lg:text-6xl text-center text-gray-800 font-bold mt-12 mb-6">
            Work
          </h1>
          ...
          <div>
            <h2
              className="text-4xl lg:text-6xl text-center text-gray-800 font-bold mt-14"
              data-aos="fade-up"
              data-aos-mirror="true"
            >
              Achievements
            ...
            <div
              className="w-[68%] mx-auto my-4 rounded-lg shadow-lg"
              data-aos="zoom-in"
              data-aos-mirror="true"
            >
              <img
                src={youtube}
                alt="Shayan Krishna YouTube feature"
                className="my-8 h-[90vw]"
              />
              <img
                src={netflix}
                alt="Shayan Krishna on Netflix"
                className="mt-40 not-first-of-type:mb-20"
              />
            </div>
            <div
              className="bg-gradient-to-r from-red-600 to-blue-600
 w-full max-w-[90vw] lg:max-w-[60vw] mx-auto my-10 border-gray-200 shadow-lg rounded-xl p-6"
              data-aos="flip-left"
