...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send('service_kcq5f8l', 'template_qabnrsd', formData, 'HKAltfNatDH2owIvW')
      .then((response) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div data-aos="flip" className="flex flex-col">
            ...
            <form data-aos="zoom-in-right"
              ...
              className=" bg-gray-800 shadow-xl rounded-xl p-8 flex-grow"
            >
              <div className="space-y-6 bg-gradient-to-br from-gray-800 to-blue-900 p-6 rounded-lg shadow-lg">
  <div>
    <label
      htmlFor="email"
    ...
    <div className="mt-4 p-3 bg-green-100 border border-green-300 text-green-700 rounded-lg">
     ...
     data-aos-duration="3000" className="font-medium mb-4">Connect with me</h3>
                <div data-aos="fade-down" className="flex items-center space-x-4">
                  ...
                  <a href="https://www.instagram.com/theblondedesi/?hl=en" className="p-2 bg-opacity-20 rounded-full hover:bg-opacity-30 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://x.com/shayan_speaks" className="text-white hover:text-yellow-300 transition-colors duration-300">
