  ...
  return (
    <footer className="select-none bg-gradient-to-r from-teal-400 to-teal-700 text-white py-8 text-center relative overflow-hidden">
      ...
      <div className="flex justify-center space-x-6 mb-4">
        <a href="https://www.facebook.com/profile.php?id=100082734665720#" className="text-white hover:text-yellow-300 transition-colors duration-300">
        ...
        <a href="https://www.instagram.com/theblondedesi/?hl=en" className="text-white hover:text-yellow-300 transition-colors duration-300">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
