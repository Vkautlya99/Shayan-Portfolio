...
const Footer = () => {
  ...
  return (
    <footer className="select-none bg-gradient-to-r from-red-600 to-blue-600 text-white py-12 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div data-aos="fade-right" className="text-left">
              ...
              <p className="text-sm text-gray-200 mb-4">
                Empowering growth with innovative strategies, cutting-edge
                technology, and personalized support for lasting success. Where
                vision meets execution — delivering excellence that fuels your
                business journey.
              </p>

              <div className="flex space-x-4">
                <a
                  href="https://www.facebook.com/vikram.ranawat.9655"
                  className="w-8 h-8 rounded-full bg-gradient-to-r from-red-600 to-blue-600 flex items-center justify-center hover:bg-yellow-400 transition-colors duration-300"
                >
                  <FaFacebookF className="w-4 h-4" />
                </a>
                <a
                  href="https://x.com/VKautalya?t=eu8aHR4gkQBoTA_hYzT-VQ&s=09"
                  className="w-8 h-8 rounded-full bg-gradient-to-r from-red-600 to-blue-600 flex items-center justify-center hover:bg-yellow-400 transition-colors duration-300"
                >
                  <FaXTwitter className="w-4 h-4" />
                </a>
                <a
                  href="https://www.instagram.com/thisisvrk?igsh=cm9heTVkYm9mZWx3"
                  className="w-8 h-8 rounded-full bg-gradient-to-r from-red-600 to-blue-600 flex items-center justify-center hover:bg-yellow-400 transition-colors duration-300"
                >
                ...
                <a
                  href="mailto:vikramkautlya2020@gmail.com"
                  className="w-8 h-8 rounded-full bg-gradient-to-r from-red-600 to-blue-600 flex items-center justify-center hover:bg-yellow-400 transition-colors duration-300"
                >
            ...
            <div data-aos="fade-up" className="text-left">
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/"
                    className="text-gray-200 hover:text-yellow-300 transition-colors duration-300 flex items-center"
                  >
            ...
            <div data-aos="fade-left" className="text-left">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <a
                    href="mailto:contact@shayankrishna.com"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">
              &copy; {currentYear}{" "}
              <span className="font-bold">VnY Corporation</span>. All Rights
              Reserved.
            </p>
