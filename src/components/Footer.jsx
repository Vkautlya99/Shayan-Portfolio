...
const Footer = () => {
  ...
  <a href="https://www.instagram.com/thisisvrk?igsh=cm9heTVkYm9mZWx3" className="text-white hover:text-yellow-300 transition-colors duration-300">
    <FaInstagram className="w-6 h-6" />
      ...
      {/* Contact Button */}
      <a href="mailto: vikramkautlya2020@gmail.com"><button className="mt-4 px-6 py-2 bg-yellow-400 text-white font-bold rounded-full hover:bg-white hover:scale-105 hover:text-teal-700 transition-all duration-300 shadow-lg">
        Get in Touch
      </button></a>
    </footer>
  );
